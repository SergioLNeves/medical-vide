describe('Authentication - Forgot Password', () => {
    ...
    it('should display forgot password page correctly', () => {
        ...
        cy.contains('Digite seu email e enviaremos um link para redefinir sua senha').should('be.visible');
        ...
        cy.get('button').contains('Enviar Link de Recuperação').should('be.visible');
    ...
    it('should test successful email submission', () => {
        ...
        cy.contains('Enviamos um link de recuperação para seu email').should('be.visible');

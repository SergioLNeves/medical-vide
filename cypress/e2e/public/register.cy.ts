describe('Authentication - Register', () => {
    ...
    it('should display register page correctly', () => {
        ...
        cy.contains('Cadastre-se como paciente para acessar o sistema').should('be.visible');
    ...
    it('should test registration with existing email', () => {
        ...
        cy.get('[data-testid="error-message"]').should('contain.text', 'Email já cadastrado');

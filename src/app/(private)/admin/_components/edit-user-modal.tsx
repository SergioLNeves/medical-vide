...
export default function EditUserModal({
    ...
    const handleConfirmEdit = () => {
        if (user) {
            ...
            const success = MockDatabase.updateUser(user.id, trimmedName, trimmedEmail, role);
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Altere os detalhes do usuário e salve as alterações.
                        Nota-se que a edição de usuários não inclui alterações de dados sensíveis.
                    </DialogDescription>
                </DialogHeader>

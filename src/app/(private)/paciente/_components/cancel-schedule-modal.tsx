        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-red-200 bg-red-50 p-4">
            <p className="mb-3 text-sm text-red-700">
              <strong>Atenção:</strong> Você está prestes a cancelar a seguinte
              consulta:
            </p>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>
                  <strong>Data:</strong> {formatDate(schedule.start)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <ClockIcon className="h-4 w-4 text-red-500" />
                <span>
                  <strong>Horário:</strong> {formatTime(schedule.start)} -{' '}
              ...
              <div className="mt-2">
                <span>
                  <strong>Consulta:</strong> {schedule.title}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
            <p className="text-sm text-yellow-800">
              <strong>Importante:</strong> Esta ação não pode ser desfeita. Você
              precisará reagendar se desejar uma nova consulta.
            </p>
          </div>

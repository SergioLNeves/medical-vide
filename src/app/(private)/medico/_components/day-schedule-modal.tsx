...
export default function DayScheduleModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent showCloseButton={false} className='max-w-3xl md:min-w-2/4 overflow-auto'>
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        <CalendarIcon className="h-5 w-5" />
                        Consultas do dia {format(selectedDate, 'dd \'de\' MMMM \'de\' yyyy', { locale: ptBR })}
                    </DialogTitle>
                </DialogHeader>
                        ...
                        <>
                            <div className="mb-4">
                                <p className="text-sm text-gray-600">
                                    {daySchedules.length} consulta{daySchedules.length !== 1 ? 's' : ''} agendada{daySchedules.length !== 1 ? 's' : ''}
                                </p>
                            </div>
